//
//  Promodo50TableViewController.swift
...
class Promodo50TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == DETAIL_SECTION {
            ...
            detailCell.textLabel?.text = "Promodoro 50/10 is a productivity technique."
            detailCell.textLabel!.text! += "\n"
            detailCell.textLabel!.text! += "It suggests to focusly work in chunks of time and take a break."
            detailCell.textLabel!.text! += "\n"
            detailCell.textLabel!.text! += "In 50/10, you work for 50 mins without distractions."
            detailCell.textLabel!.text! += "\n"
            detailCell.textLabel!.text! += "Then, take a 10 mins break."
            detailCell.textLabel!.text! += "\n"
            detailCell.textLabel!.text! += "Repeat this for 2 session at max before taking a long break."
            ...
            workCell.textLabel?.text = "Work on (a portion) of it for 50 mins"
            ...
            breakCell.textLabel?.text = "Take a 10 mins break"
            ...
            repeatCell.textLabel?.text = "Repeat this for at max 2 times before taking a longer break"
